...
Start: _-RunPythonScript "<Pfad>/gisloader.py" (Alias oder Werkzeugknopf).
...
def import_export(doc, p, export_id, folder=None):
    ...
    if georef:
        ...
        doc.Strings.SetString("gisloader:axis_note", "X = Ost, Y = Nord, Z = Höhe (Z-up); Ursprung Südwest-Ecke des Ausschnitts")
