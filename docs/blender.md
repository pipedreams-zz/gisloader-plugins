...
- Die Versionsnummer des Add-ons steht im Panel-Titel.
...
Voraussetzung: Blender 3.6 oder neuer (ab 4.2 als Erweiterung).
...
3. In den Einstellungen des Add-ons die E-Mail eintragen, „Anmelden“ klicken
   und das Passwort eingeben. Die Sitzung bleibt in den Einstellungen
   gespeichert; die Serveradresse ist vorbelegt.

Update: die neue Zip genauso installieren, Blender ersetzt die alte Fassung.
Danach Blender neu starten, damit die Brücke sauber neu bindet.
